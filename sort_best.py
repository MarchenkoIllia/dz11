...
def SortInsert(sorting_list:list, start=1):
...
def SortShell(sorting_list:list):
...
def SortMerge(sorting_list:list):
    metrics[0] +=1
...
def SortQuick(sorting_list:list, leftInd=0, rightInd=0):
    if rightInd == 0:
